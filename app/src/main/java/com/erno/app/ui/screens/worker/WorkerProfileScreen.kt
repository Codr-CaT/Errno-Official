        ...
        LazyColumn(
            ...
            item {
                Surface(
                    ...
                    Column(
                        ...
                        Text(
                            text = "Experienced Helper & Assistant",
                            fontSize = 13.sp,
            ...
            item {
                Row(
                    ...
                    WorkerProfileStatCard("Jobs Completed", "14", Modifier.weight(1f))
                    WorkerProfileStatCard("Total Earned", "₹${state.totalEarnings}", Modifier.weight(1f))
                    WorkerProfileStatCard("Rating", "4.8 ★", Modifier.weight(1f))
                }
            }
                ...
                Surface(
                    ...
                    Column(modifier = Modifier.padding(vertical = 8.dp)) {
                        ...
                        WorkerProfileOptionItem(
                            ...
                            title = "My Skills & Preferred Work",
                            onClick = { }
                        )
                        HorizontalDivider(color = Color(0xFFF5F5F5))
                        WorkerProfileOptionItem(
...
@Composable
fun WorkerProfileStatCard(label: String, value: String, modifier: Modifier = Modifier) {
    Surface(
        modifier = modifier,
